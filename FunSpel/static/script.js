...
function start() {
    ...
    document.getElementById("monads").addEventListener("click", function(){load_page('04_Monads.html')});
    document.getElementById("hof").addEventListener("click", function(){load_page('05_HOF.html')});
    document.getElementById("lenses").addEventListener("click", function(){load_page('06_Lenses.html')});
    document.getElementById("bibliography").addEventListener("click", function(){load_page('07_Bibliography.html')});
 }
